      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h1 className="text-xl font-black text-brand-blue tracking-tighter uppercase leading-none">El Líder</h1>
               <p className="text-[9px] font-black text-brand-red uppercase tracking-widest mt-1">Materiales para la obra</p>
             </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              ...
              <Button variant="outline" className="h-14 px-10 text-lg font-black border-white/20 text-white hover:bg-white/5">
                Nuestra Ubicación
              </Button>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
               ...
               <h1 className="text-xl font-black tracking-tighter uppercase whitespace-nowrap">El Líder</h1>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-slate-400">
              <li className="flex items-start gap-3"><MapPin size={18} className="text-brand-red shrink-0" /> Av. Falsa 123, Corrientes</li>
              <li className="flex items-center gap-3"><Phone size={18} className="text-brand-red shrink-0" /> 11 6469-5865</li>
